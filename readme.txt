...
Download link:	https://github.com/azurecurve/azrcrv-maintenance-mode/releases/download/v1.2.0/azrcrv-maintenance-mode.zip
Requires PHP:	5.6
Requires:		1.0.0
Tested:			4.9.99
...
* Download the plugin from [GitHub](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/latest/).
