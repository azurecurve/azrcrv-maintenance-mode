 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_mm' ) ) {
	function azrcrv_create_plugin_menu_mm() {
		azrcrv_populate_plugin_menu_mm();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_mm' ) ) {
	function azrcrv_populate_plugin_menu_mm() {
