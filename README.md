...
Enable maintenance mode to disable the front-end of your ClassicPress site.
...
### [Version 2.0.5](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v2.0.5)
...
### [Version 2.0.4](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v2.0.4)

* Upgrade UpdateClient.
* Update azurecurve plugins.
* Replace jquery with vanilla js.

### [Version 2.0.3](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v2.0.3)

* Update plugin header for compatibility with ClasssicPress v2.

### [Version 2.0.2](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v2.0.2)

* Update plugin header and readme for compatibility with ClassicPress Directory v2.
* Update Update Manager to version 2.5.0.

### [Version 2.0.1](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v2.0.1)
...
### [Version 1.3.1](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v1.3.1)
...
### [Version 1.2.1](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v1.2.1)

* Update azurecurve menu.
* Update readme files.

### [Version 1.2.0](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v1.2.0)

* Add uninstall.
* Update translations to escape strings.

### [Version 1.1.0](https://github.com/azurecurve/azrcrv-maintenance-mode/releases/tag/v1.1.0)

* Change Enabled default to off.
* Update azurecurve menu.
